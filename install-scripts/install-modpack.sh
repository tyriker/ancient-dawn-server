...
root_dir_in_modpack="Server TAD"
echo "download modpack"
...
unzip "${modpack_name}.zip"
rsync -a --remove-source-files "${root_dir_in_modpack}"/* serverfiles
rm -r "${root_dir_in_modpack}"
